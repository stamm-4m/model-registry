...
class ProjectRepository(BaseRepository):
    ...
    def delete_if_no_lab_users(self, project_id):
        ...
        for lab_proj in lab_projects:
            ...
            user_count = (
                ...
                .filter(LaboratoryUser.laboratory_id == lab_proj.laboratory_id)
                .count()
            )
            if user_count > 0:
                raise ProjectInUseException(
                    "Cannot delete project: laboratory has assigned users."
                )
    ...
    def assign_to_lab(self, project_id, lab_id):
        relation = LaboratoryProject(project_id=project_id, laboratory_id=lab_id)
    ...
    def update_project_lab(self, project_id, lab_id):
        ...
        if rel:
            ...
            rel = LaboratoryProject(project_id=project_id, laboratory_id=lab_id)
            self.db.add(rel)
    ...
    def get_full_project(self, project_id):
        result = (
            ...
            .join(
                ...
                DepartmentLaboratory.laboratory_id == LaboratoryProject.laboratory_id,
            )
