        ...
        [
            ...
            dbc.ModalBody(
                [
                    dbc.Label("Full Name"),
                    dbc.Input(
                        id="user-name-input", type="text", placeholder="Enter full name"
                    ),
                    dbc.Label("Email", className="mt-3"),
                    dbc.Input(
                        id="user-email-input", type="email", placeholder="Enter email"
                    ),
                    ...
                    dcc.Dropdown(
                        id="user-dept-dropdown", placeholder="Select department"
                    ),
                    dbc.Label(
                        "Laboratory",
                        className="mt-3",
