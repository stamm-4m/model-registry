...
def register_sidebar_callbacks(app):
    ...
    def display_page(pathname, session_data, current_children):
        ...
        is_authenticated = bool(session_data and session_data.get("authenticated"))
        ...
        if triggered_ids == {"user-session"} and is_authenticated and current_children:
            return no_update
    ...
    @app.callback(
        [Output("organization-link", "className"), Output("project-link", "className")],
        Input("url", "pathname"),
    )
