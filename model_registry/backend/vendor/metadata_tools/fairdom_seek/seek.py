...
class seek:
    ...
    def make_backup_dir(self, backup_path_: str = 'backup/', inc_timestamp_:bool = False) -> None:
        ...
        """
        self.backup_filepath = self.make_dir(path_ = backup_path_, inc_timestamp = inc_timestamp_)  
    ...
    def get_known_assets(self, seek_url_for_asset = 'projects', store_info = False,):
        """ FIND ASSET IN SEEK
            INPUT:
        ...
        if store_info: 
            ...
            for idx in range(len(result['data'])):
                ...
                output_dict[name_value] = {'name' : name_value, 'id' : id_value, 'url' : url_value}
                        
            return output_dict
        


    def find_asset_in_seek(self, asset_to_find,  seek_url_for_asset = 'projects', store_info = False,
    ...
    def switch_dict_keys(self, dictionary_: dict, new_idx_key: str|float|int = 'id'):
