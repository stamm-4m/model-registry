            ...
            [
                html.Div(
                    [
                        ...
                        html.Div(
                            f"Organization: {org_name or _DASH}", className="tree-sub"
                        ),
                        html.Div(
                            f"Created {_fmt_date(dept.created_at)}"
                            if dept.created_at
                            else "",
                            className="tree-meta",
                        ),
            ...
            dbc.Modal(
                [
                    ...
                    dbc.ModalFooter(
                        [
                            dbc.Button(
                                "Cancel", id="btn-cancel-delete-dept", color="secondary"
                            ),
                            dbc.Button(
                                "Delete", id="btn-confirm-delete-dept", color="danger"
                            ),
                        ]
                    ),
                ],
