...
# Define request format for PSI drift detection
class DriftRequest(BaseModel):
    expected_data: list  # List of expected (reference) data values
    actual_data: list    # List of actual (new) data values
